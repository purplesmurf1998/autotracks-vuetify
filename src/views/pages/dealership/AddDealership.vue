...
export default {
  ...
  methods: {
    confirmCreate() {
      DealershipService.createDealership(this.accountId, {
    ...
    geocodeDealership() {
      this.loading = true;
      DealershipService.geocodeDealership(this.accountId, {
        street: this.street,
        city: this.city,
        province_state: this.provinceState,
        country: this.country,
      })
        .then((response) => {
          this.geocodedAddress = response.data;
