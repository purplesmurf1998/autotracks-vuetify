<template>
  <v-card>
    ...
    <div v-else>
      ...
      <v-card-text>
        <p>You are unable to add more roles to this dealership as you have reached the maximum amount allowed.</p>
        <p><a href="#">Upgrade</a> your account plan in order to create additional roles.</p>
      </v-card-text>
      <v-divider />
      <v-card-actions>
